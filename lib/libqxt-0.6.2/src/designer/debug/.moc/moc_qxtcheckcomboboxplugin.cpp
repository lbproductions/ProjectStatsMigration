...
void QxtCheckComboBoxPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData QxtCheckComboBoxPlugin::staticMetaObjectExtraData = {
...
const QMetaObject QxtCheckComboBoxPlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QxtCheckComboBoxPlugin,
      qt_meta_data_QxtCheckComboBoxPlugin, &staticMetaObjectExtraData }
};
