...
static const char qt_meta_stringdata_QxtLetterBoxWidgetPrivate[] = {
    "QxtLetterBoxWidgetPrivate\0"
};
...
const QMetaObjectExtraData QxtLetterBoxWidgetPrivate::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QxtLetterBoxWidgetPrivate::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QxtLetterBoxWidgetPrivate,
      qt_meta_data_QxtLetterBoxWidgetPrivate, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QxtLetterBoxWidgetPrivate::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QxtLetterBoxWidgetPrivate))
