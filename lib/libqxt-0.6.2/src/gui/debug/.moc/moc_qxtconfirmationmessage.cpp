...
void QxtConfirmationMessage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QxtConfirmationMessage *_t = static_cast<QxtConfirmationMessage *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData QxtConfirmationMessage::staticMetaObjectExtraData = {
...
const QMetaObject QxtConfirmationMessage::staticMetaObject = {
    { &QMessageBox::staticMetaObject, qt_meta_stringdata_QxtConfirmationMessage,
      qt_meta_data_QxtConfirmationMessage, &staticMetaObjectExtraData }
};
