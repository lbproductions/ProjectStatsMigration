...
void QxtTcpConnectionManagerPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QxtTcpConnectionManagerPrivate *_t = static_cast<QxtTcpConnectionManagerPrivate *>(_o);
        switch (_id) {
        case 0: _t->socketDisconnected((*reinterpret_cast< QObject*(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData QxtTcpConnectionManagerPrivate::staticMetaObjectExtraData = {
...
const QMetaObject QxtTcpConnectionManagerPrivate::staticMetaObject = {
    { &QTcpServer::staticMetaObject, qt_meta_stringdata_QxtTcpConnectionManagerPrivate,
      qt_meta_data_QxtTcpConnectionManagerPrivate, &staticMetaObjectExtraData }
};
