...
void QxtAbstractWebSessionManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QxtAbstractWebSessionManager *_t = static_cast<QxtAbstractWebSessionManager *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData QxtAbstractWebSessionManager::staticMetaObjectExtraData = {
...
const QMetaObject QxtAbstractWebSessionManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QxtAbstractWebSessionManager,
      qt_meta_data_QxtAbstractWebSessionManager, &staticMetaObjectExtraData }
};
