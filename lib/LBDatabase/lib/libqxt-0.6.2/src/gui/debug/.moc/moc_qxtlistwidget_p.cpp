...
**
** Created: Wed May 16 14:16:29 2012
...
void QxtListWidgetPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QxtListWidgetPrivate *_t = static_cast<QxtListWidgetPrivate *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData QxtListWidgetPrivate::staticMetaObjectExtraData = {
...
const QMetaObject QxtListWidgetPrivate::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QxtListWidgetPrivate,
      qt_meta_data_QxtListWidgetPrivate, &staticMetaObjectExtraData }
};
