...
**
** Created: Wed May 16 14:16:07 2012
...
void QxtBaseSpinBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QxtBaseSpinBox *_t = static_cast<QxtBaseSpinBox *>(_o);
        switch (_id) {
        case 0: _t->baseChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->setBase((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData QxtBaseSpinBox::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QxtBaseSpinBox::staticMetaObject = {
    { &QSpinBox::staticMetaObject, qt_meta_stringdata_QxtBaseSpinBox,
      qt_meta_data_QxtBaseSpinBox, &staticMetaObjectExtraData }
};
