...
**
** Created: Wed May 16 14:16:32 2012
...
void QxtProgressLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QxtProgressLabel *_t = static_cast<QxtProgressLabel *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData QxtProgressLabel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QxtProgressLabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_QxtProgressLabel,
      qt_meta_data_QxtProgressLabel, &staticMetaObjectExtraData }
};
