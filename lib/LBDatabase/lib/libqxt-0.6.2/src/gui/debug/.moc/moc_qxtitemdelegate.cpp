...
**
** Created: Wed May 16 14:16:23 2012
...
void QxtItemDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QxtItemDelegate *_t = static_cast<QxtItemDelegate *>(_o);
        switch (_id) {
        case 0: _t->editingStarted((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        case 1: _t->editingFinished((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObjectExtraData QxtItemDelegate::staticMetaObjectExtraData = {
    qt_meta_extradata_QxtItemDelegate,  qt_static_metacall 
};

const QMetaObject QxtItemDelegate::staticMetaObject = {
    { &QItemDelegate::staticMetaObject, qt_meta_stringdata_QxtItemDelegate,
      qt_meta_data_QxtItemDelegate, &staticMetaObjectExtraData }
};
