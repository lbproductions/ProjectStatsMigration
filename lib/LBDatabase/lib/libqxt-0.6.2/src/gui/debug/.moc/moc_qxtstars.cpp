...
**
** Created: Wed May 16 14:16:36 2012
...
void QxtStars::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData QxtStars::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QxtStars::staticMetaObject = {
    { &QAbstractSlider::staticMetaObject, qt_meta_stringdata_QxtStars,
      qt_meta_data_QxtStars, &staticMetaObjectExtraData }
};
