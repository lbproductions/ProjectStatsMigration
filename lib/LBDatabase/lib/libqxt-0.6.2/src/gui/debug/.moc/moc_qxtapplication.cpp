...
void QxtApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData QxtApplication::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QxtApplication::staticMetaObject = {
    { &QApplication::staticMetaObject, qt_meta_stringdata_QxtApplication,
      qt_meta_data_QxtApplication, &staticMetaObjectExtraData }
};
