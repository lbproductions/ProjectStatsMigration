...
**
** Created: Wed May 16 14:16:34 2012
...
void QxtPushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData QxtPushButton::staticMetaObjectExtraData = {
    qt_meta_extradata_QxtPushButton,  qt_static_metacall 
};

const QMetaObject QxtPushButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_QxtPushButton,
      qt_meta_data_QxtPushButton, &staticMetaObjectExtraData }
};
