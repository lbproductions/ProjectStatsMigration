...
static const char qt_meta_stringdata_QxtCsvModel[] = {
    "QxtCsvModel\0"
};
...
const QMetaObjectExtraData QxtCsvModel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QxtCsvModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_QxtCsvModel,
      qt_meta_data_QxtCsvModel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QxtCsvModel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QxtCsvModel))
        return static_cast<void*>(const_cast< QxtCsvModel*>(this));
