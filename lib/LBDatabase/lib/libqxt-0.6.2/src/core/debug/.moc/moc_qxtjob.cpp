...
**
** Created: Wed May 16 14:09:54 2012
...
void QxtJob::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QxtJob *_t = static_cast<QxtJob *>(_o);
        switch (_id) {
        case 0: _t->done(); break;
        case 1: _t->subseed(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData QxtJob::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QxtJob::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QxtJob,
      qt_meta_data_QxtJob, &staticMetaObjectExtraData }
};
