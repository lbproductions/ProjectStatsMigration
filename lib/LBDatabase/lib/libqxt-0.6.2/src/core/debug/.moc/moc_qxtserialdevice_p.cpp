...
**
** Created: Wed May 16 14:10:05 2012
...
void QxtSerialDevicePrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QxtSerialDevicePrivate *_t = static_cast<QxtSerialDevicePrivate *>(_o);
        switch (_id) {
        case 0: { int _r = _t->fillBuffer();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 1: { int _r = _t->constFillBuffer();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        default: ;
        }
    }
...
const QMetaObjectExtraData QxtSerialDevicePrivate::staticMetaObjectExtraData = {
...
const QMetaObject QxtSerialDevicePrivate::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QxtSerialDevicePrivate,
      qt_meta_data_QxtSerialDevicePrivate, &staticMetaObjectExtraData }
};
